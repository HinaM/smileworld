    ...
    #10答案
        ...
        if event.source.user_id in userid_list:
            ...
            if worksheet.acell(list[0]).value=="1" and worksheet.acell(list[1]).value=="1":
                ...
                list_talk.append(TextSendMessage(text="#11 python程式碼如下，請問輸出結果為？（Ａ）1234（Ｂ）0123（Ｃ）123（Ｄ）012"))
